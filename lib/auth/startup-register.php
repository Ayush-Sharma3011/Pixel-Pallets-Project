        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-dark bg-opacity-50 rounded-xl p-8 md:p-12">
                ...
                <form action="register-process.php" method="post">
                    <input type="hidden" name="user_type" value="startup">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="company_name" name="company_name" required class="w-full bg-dark bg-opacity-50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-primary">
                    </div>
                    ...
                    <div class="mb-8">
                        <label class="flex items-center">
                            <input type="checkbox" name="terms" required class="rounded text-primary focus:ring-primary">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <button type="submit" class="bg-primary hover:bg-opacity-90 text-white font-medium py-3 px-8 rounded-lg transition">Register</button>
                    </div>
                </form>
            </div>
            
            <div class="mt-8 text-center">
                <p class="text-gray-400">Already have an account? <a href="../../login.php" class="text-primary hover:underline">Sign in</a></p>
                <p class="text-gray-400 mt-2">Are you a corporate? <a href="corporate-register.php" class="text-primary hover:underline">Register as a Corporate</a></p>
            </div>
        </div>
    </section>
